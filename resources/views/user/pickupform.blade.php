                    ...
                    <div class="theme-container container">
                        <div class="row">
                            <div class="col-md-2 col-sm-2">
                                ...
                                <a class="navbar-logo" href="#"> <img src="/homecss/img/logo/logo-black.png" alt="logo" /> </a>
                            </div>
  ...
  <body class="bg-light">
    ...
    <div class="container">
      <div class="py-5 text-center">
        ...
        <h2>Request Form</h2>
        <p class="lead">Please fill the form below to request the </p>
      </div>

      <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
          <h4 class="d-flex justify-content-between align-items-center mb-3">
            <span class="text-muted">Track Shipment</span>
          </h4>
            <form class="card p-2">
          ...
          <form class="form-horizontal" method="POST" action="{{ route('order.store') }}">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="name" placeholder="" value="" name="recipient_name" required>
                <div class="invalid-feedback">
                  Valid recipient name is required.
                </div>
              </div>
            <div class="col-md-6 mb-3">
            ...
            <!-- 
            <div class="mb-3">
              <label for="email">Recipient Email <span class="text-muted">(Optional)</span></label>
