...
c){a.css("min-height",40)},stop:function(b,c){a.css("min-height","")}})},c=function(a){},d=function(a){var b=$(this).children("i");b.addClass("fa fa-spin");setTimeout(function(){b.removeClass("fa fa-spin")},2E3)},e=function(a){a=$(this);var b=a.parents(".dashboard-widget:first");b.hasClass("dashboard-widget-closed")?(a.data("tooltip","Close"),a.children("i").attr("class","fa fa-chevron-down"),b.removeClass("dashboard-widget-closed")):(a.data("tooltip","Open"),a.children("i").attr("class","fa fa-chevron-up"),
 ...
 * @email   lee@melonhtml5.com
 */
var Notification=function(f){var b=null,e=0,g=function(a){b||(b=$("<div>").addClass("notification-container").appendTo($(document.body)));var d='<div class="close"><i class="fa fa-times"></i></div>';a.title&&(d+='<div class="title">'+a.title+"</div>");var d=d+('<div class="content">'+a.content+"</div>"),c=$("<div>").html(d).addClass("notification").prependTo(b);0<a.countdown&&(a=setTimeout(function(){c.children("div.close").trigger("click")},a.countdown),c.data("timeout_id",a));e++},h=function(a){e--;
 ...
 * @email   lee@melonhtml5.com
 */
var Table=function(f){this.init=function(){$(document).on("mouseenter","div.data-table > table tbody th",c);$(document).on("mouseleave","div.data-table > table tbody th",d);$(document).on("click","div.data-table > table tbody th input:checkbox",e)};var c=function(a){a=$(this);if(a.children(".fa fa-sort").length){if(!a.data("columns")){var b=a.index();a.data("columns",a.parents("table:first").find("tbody td:nth-child("+(b+1)+")"))}a.addClass("hover");a.data("columns").addClass("hover")}},d=function(a){a=
$(this);if(a.children(".fa fa-sort").length){if(!a.data("columns")){var b=a.index();a.data("columns",a.parents("table:first").find("tbody td:nth-child("+(b+1)+")"))}a.removeClass("hover");a.data("columns").removeClass("hover")}},e=function(a){a=$(this);if(!a.data("checkboxes")){var b=a.index();a.data("checkboxes",a.parents("table:first").find("tbody td:nth-child("+(b+1)+")").children("input:checkbox"))}a.data("checkboxes").prop("checked",a.prop("checked"))}};
