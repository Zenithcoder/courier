            ...
            App.dialog.open({
                ...
                content:   '<form>' +
                               '<div class="form-row">' +
                                   ...
                                   '<div class="input">' +
                                       '<i class="fa fa-calendar"></i><input type="text" class="icon large" placeholder="event title" autofocus="autofocus" />' +
                                   '</div>' +
                               '</div>' +
                            '</form>',
                theme:     'info',
...
$(document).ready(function() {
    ...
    $('#theme-selector div.theme').on('click', function(evt) {
        ...
        $('<link>').attr({
            rel:  'stylesheet',
            href: (!App.getOptions().spa ? '../dashcss/' : '') + 'css/theme/default/' + colour + '.css?k=' + key
        }).on('load', function() {
...
$(document).ready(function() {
    $(document).on('click', 'button.form-submit-ajax', function(evt) {
        ...
        button.children('i').attr('class', 'fa fa-refresh fa-spin');
            ...
            if ($(this).parent().hasClass('message')) {
                ...
                var buttons = [
                    ...
                    },
                    {
                        ...
                        click:     function(evt, btn) {
                            btn.children('i').attr('class', 'fa fa-refresh fa-spin')
                            btn.prop('disabled', true);

                            setTimeout(function() {
                                btn.children('i').attr('class', 'fa fa-save')
